...
export const supportAreas: SupportArea[] = [
  {
    key: "immune",
    titleSw: "Usaidizi wa Kinga ya Mwili",
    titleEn: "Immune Support",
    noteSw:
      "Kwa VVU/UKIMWI tunatoa vifurushi vya usaidizi wa VVU/UKIMWI na usaidizi wa ustawi tu; huduma hizi hazichukui nafasi ya ARVs au matibabu ya kliniki.",
    noteEn:
      "For HIV/AIDS, we provide HIV/AIDS Support Packages and supportive wellness only; this does not replace ARVs or clinical treatment.",
  ...
  },
  {
    ...
    noteSw: "Tunatoa usaidizi wa utulivu wa tumbo; hatudai tiba ya vidonda.",
  ...
  },
  {
    ...
    noteSw: "Kwa hepatitis tunatoa usaidizi wa ustawi pekee, si mbadala wa tiba rasmi.",
  ...
  {
    key: "cycle",
    titleSw: "Usaidizi wa Mzunguko wa Hedhi",
  ...
  {
    key: "sugar",
    titleSw: "Usaidizi wa Sukari",
    titleEn: "Blood Sugar Support",
    noteSw: "Kwa kisukari, huduma zetu ni usaidizi wa mtindo wa maisha; si tiba wala mbadala wa dawa.",
