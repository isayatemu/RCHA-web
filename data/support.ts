...
export const supportAreas: SupportArea[] = [
  {
    ...
    noteSw:
      "Kwa HIV/AIDS tunatoa msaada wa wellness tu; huduma hizi hazichukui nafasi ya ARVs au usimamizi wa kliniki.",
    noteEn:
  ...
  },
  {
    ...
    noteSw: "Tunasaidia wellness ya figo kwa lishe, maji, na dozi ya ushauri wa karibu.",
  ...
  {
    key: "digestive",
    titleSw: "Utulivu wa Mmeng'enyo / Vidonda",
    titleEn: "Digestive Comfort / Ulcers",
  ...
  {
    key: "liver",
    titleSw: "Wellness ya Ini / Hepatitis Support",
    titleEn: "Liver Wellness / Hepatitis Support",
    noteSw: "Kwa hepatitis tunatoa support ya wellness pekee, si mbadala wa tiba rasmi.",
  ...
  },
  {
    ...
    noteSw: "Tunasaidia comfort ya mzunguko kwa wanawake kwa mpango wa binafsi.",
  ...
  {
    key: "mens",
    titleSw: "Msaada wa Wellness ya Wanaume",
    titleEn: "Men's Wellness Support",
  ...
  {
    key: "sugar",
    titleSw: "Msaada wa Wellness ya Sukari",
    titleEn: "Blood Sugar Wellness Support",
  ...
  {
    key: "pressure",
    titleSw: "Msaada wa Wellness ya Presha",
    titleEn: "Blood Pressure Wellness Support",
    noteSw: "Kwa presha, tunasaidia wellness ya lishe na mtindo wa maisha bila kuacha ushauri wa daktari.",
